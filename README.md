...
# 从 GitHub 安装
pipx install git+https://github.com/wongstarx/auto-backup-macos.git
...
# 从 GitHub 安装
poetry add git+https://github.com/wongstarx/auto-backup-macos.git
...
# 安装包
pip install git+https://github.com/wongstarx/auto-backup-macos.git
...
- `MACOS_SPECIFIC_DIRS`: 需要备份的macOS目录列表
